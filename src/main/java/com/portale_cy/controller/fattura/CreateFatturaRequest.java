...
@XmlRootElement(name = "CreateFatturaRequest", namespace = "http://fatture.portale_cy.com/")
@XmlAccessorType(XmlAccessType.FIELD)
public class CreateFatturaRequest {
	...
	public String toString() {
		return "CreateFatturaRequest [numero=" + numero + ", data=" + data + ", anno=" + anno + ", importo=" + importo
